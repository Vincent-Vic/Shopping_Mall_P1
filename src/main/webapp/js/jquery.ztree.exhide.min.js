			...
			setFirstNodeForShow: function(c, a) {
				...
				for(e = 0, g = a.length; e < g; e++)
					if(b = a[e], !f && !b.isHidden &&
						...
						f = b;
						break
					} else if(!f && !b.isHidden && !b.isFirstNode) b.isFirstNode = !0, f = b, d.setNodeLineIcos(c, b);
			...
			setLastNodeForShow: function(c, a) {
				...
				for(e = a.length - 1; e >= 0; e--)
					if(b = a[e], !g && !b.isHidden &&
						...
						g = b;
						break
					} else if(!g && !b.isHidden && !b.isLastNode) b.isLastNode = !0, g = b, d.setNodeLineIcos(c, b);
