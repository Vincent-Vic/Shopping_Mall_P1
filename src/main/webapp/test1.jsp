...
<hr/>
<br/>
<form name="input" action="http://localhost:8088/iflags_war/user/login.do" method="post" enctype="multipart/form-data" accept-charset="utf-8" target="_blank">
...
<br/>
上传文件
<form name="form1" action="http://localhost:8088/iflags_war/manage/product/upload.do" method="post" enctype="multipart/form-data">
...
<br>
富文本上传文件
<form name="form2" action="http://localhost:8088/iflags_war/iflags_war/manage/product/richtext_img_upload.do" method="post" enctype="multipart/form-data">
    <input type="file" name="upload_file"/>
    <input type="submit" value="mvc">
</form>
<script>
