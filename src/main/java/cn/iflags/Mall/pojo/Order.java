...
public class Order {
    ...
    public Order(Integer id, String orderNo, Integer userId, Integer shippingId, BigDecimal payment, Integer paymentType, Integer postage, String express_order, String express_type, Integer delivery_type, Integer status, Date paymentTime, Date sendTime, Date endTime, Date closeTime, Date createTime, Date updateTime) {
        this.id = id;
